...
model_gam <- function(x){ # EC.params, EC.env){
  ...
  model_compute_sdm <- mode_compute(predictor_info,
                                    ...
                                    model_options_biomod, model_options_gam)
...
# subfunctions to run model_gam()

build_gam_options<- function(a){
