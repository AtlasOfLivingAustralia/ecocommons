...
#===================================================================
# subfunctions, for algorithms scripts
...
build_response <- function(a){
  # Set species data for modelling
  list(
    ...
    absen_data    = a$species_absence_dataset$filename,  # background/pseudoabsence points- 2 column matrix
...
build_predictor <- function(
  ...
  # Set environmental data for modelling
  list(
