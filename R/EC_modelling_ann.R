...
#' predictor variables to predict species occurrence probablities
#' 
...
EC_modelling_ann <- function(a,# EC.params
  ...
  model_accuracy_ann <- c(model_options_statregr$biomod_eval_method,
  ...
  model_compute <- EC_compute_statregr (predictor_info, pa_number_point, a,
                                        model_options_statregr, model_options_ann)
