...
#' @param species 
#'
#' @export EC_summary_stats
#' @importFrom dismo evaluate
#' @importFrom dismo threshold

EC_summary_stats <- function(occur, absen, model, predictor, species) {
  ...
  threshold_all <- dismo::threshold(evaluation)
  threshold_all <- subset(threshold_all[,1:5]) # leave out sensitivity threshold
  threshold_kappa <- dismo::threshold(evaluation, stat= 'kappa')
  threshold_spec_sens <- dismo::threshold(evaluation, stat= 'spec_sens')
  threshold_no_omission <- dismo::threshold(evaluation, stat= 'no_omission')
  threshold_prevalence <- dismo::threshold(evaluation, stat= 'prevalence')
  threshold_equal_sens_spec <- dismo::threshold(evaluation, stat= 'equal_sens_spec')
  ...
  kappa_bind <- rbind(kappa_CCR, kappa_FNR, kappa_FPR, kappa_MCR, kappa_NPP,
                      kappa_ODP, kappa_OR, kappa_PPP, kappa_prevalence,
                      kappa_TNR, kappa_TPR)
  ...
  equal_sens_spec_bind <- rbind(equal_sens_spec_CCR, equal_sens_spec_FNR,
                                equal_sens_spec_FPR, equal_sens_spec_MCR,
                                equal_sens_spec_NPP, equal_sens_spec_ODP,
                                equal_sens_spec_OR, equal_sens_spec_PPP,
                                equal_sens_spec_prevalence, equal_sens_spec_TNR,
                                equal_sens_spec_TPR)
